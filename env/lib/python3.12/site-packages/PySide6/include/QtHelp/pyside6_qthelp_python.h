...
enum [[deprecated]] : int {
    ...
    SBK_QTHELP_QLIST_QHELPSEARCHRESULT_IDX                   = 18, // QList<QHelpSearchResult>
    SBK_QTHELP_STD_PAIR_QSTRING_QSTRING_IDX                  = 20, // std::pair<QString,QString>
    SBK_QTHELP_QLIST_STD_PAIR_QSTRING_QSTRING_IDX            = 22, // QList<std::pair<QString,QString>>
...
enum : int {
    ...
    SBK_QtHelp_QList_QHelpSearchResult_IDX                   = 9, // QList<QHelpSearchResult>
    SBK_QtHelp_std_pair_QString_QString_IDX                  = 10, // std::pair<QString,QString>
    SBK_QtHelp_QList_std_pair_QString_QString_IDX            = 11, // QList<std::pair<QString,QString>>
