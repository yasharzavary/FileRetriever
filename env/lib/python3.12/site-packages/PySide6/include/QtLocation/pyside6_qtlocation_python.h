...
enum [[deprecated]] : int {
    ...
    SBK_QTLOCATION_QLIST_QOBJECTPTR_IDX                      = 26, // QList<QObject*>
    SBK_QTLOCATION_QLIST_QBYTEARRAY_IDX                      = 28, // QList<QByteArray>
    SBK_QTLOCATION_QLIST_QLOCALE_IDX                         = 30, // QList<QLocale>
    SBK_QTLOCATION_QLIST_QGEOLOCATION_IDX                    = 32, // QList<QGeoLocation>
    SBK_QTLOCATION_QLIST_QVARIANT_IDX                        = 34, // QList<QVariant>
    SBK_QTLOCATION_QLIST_QSTRING_IDX                         = 36, // QList<QString>
    SBK_QTLOCATION_CONVERTERS_IDX_COUNT                      = 38,
};
