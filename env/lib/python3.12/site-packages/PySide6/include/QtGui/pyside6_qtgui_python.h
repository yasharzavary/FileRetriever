...
enum [[deprecated]] : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 964,
    ...
    SBK_QPDFOUTPUTINTENT_IDX                                 = 478,
    SBK_QPDFWRITER_COLORMODEL_IDX                            = 482,
    SBK_QPDFWRITER_IDX                                       = 480,
    SBK_QPEN_IDX                                             = 484,
    SBK_QPICTURE_IDX                                         = 486,
    SBK_QPIXELFORMAT_COLORMODEL_IDX                          = 498,
    SBK_QPIXELFORMAT_ALPHAUSAGE_IDX                          = 494,
    SBK_QPIXELFORMAT_ALPHAPOSITION_IDX                       = 490,
    SBK_QPIXELFORMAT_ALPHAPREMULTIPLIED_IDX                  = 492,
    SBK_QPIXELFORMAT_TYPEINTERPRETATION_IDX                  = 500,
    SBK_QPIXELFORMAT_YUVLAYOUT_IDX                           = 502,
    SBK_QPIXELFORMAT_BYTEORDER_IDX                           = 496,
    SBK_QPIXELFORMAT_IDX                                     = 488,
    SBK_QPIXMAP_IDX                                          = 504,
    SBK_QPIXMAPCACHE_IDX                                     = 506,
    SBK_QPIXMAPCACHE_KEY_IDX                                 = 508,
    SBK_QPLATFORMSURFACEEVENT_SURFACEEVENTTYPE_IDX           = 512,
    SBK_QPLATFORMSURFACEEVENT_IDX                            = 510,
    SBK_QPOINTEREVENT_IDX                                    = 514,
    SBK_QPOINTINGDEVICE_POINTERTYPE_IDX                      = 520,
    SBK_QFLAGS_QPOINTINGDEVICE_POINTERTYPE_IDX               = 182,
    SBK_QPOINTINGDEVICE_GRABTRANSITION_IDX                   = 518,
    SBK_QPOINTINGDEVICE_IDX                                  = 516,
    SBK_QPOINTINGDEVICEUNIQUEID_IDX                          = 522,
    SBK_QPOLYGON_IDX                                         = 524,
    SBK_QPOLYGONF_IDX                                        = 526,
    SBK_QPYTEXTOBJECT_IDX                                    = 528,
    SBK_QQUATERNION_IDX                                      = 530,
    SBK_QRADIALGRADIENT_IDX                                  = 532,
    SBK_QRASTERWINDOW_IDX                                    = 534,
    SBK_QRAWFONT_ANTIALIASINGTYPE_IDX                        = 538,
    SBK_QRAWFONT_LAYOUTFLAG_IDX                              = 540,
    SBK_QFLAGS_QRAWFONT_LAYOUTFLAG_IDX                       = 184,
    SBK_QRAWFONT_IDX                                         = 536,
    SBK_QREGION_REGIONTYPE_IDX                               = 544,
    SBK_QREGION_IDX                                          = 542,
    SBK_QREGULAREXPRESSIONVALIDATOR_IDX                      = 546,
    SBK_QRESIZEEVENT_IDX                                     = 548,
    SBK_QRGBA64_IDX                                          = 550,
    SBK_QRHI_IMPLEMENTATION_IDX                              = 564,
    SBK_QRHI_FLAG_IDX                                        = 560,
    SBK_QFLAGS_QRHI_FLAG_IDX                                 = 190,
    SBK_QRHI_FRAMEOPRESULT_IDX                               = 562,
    SBK_QRHI_FEATURE_IDX                                     = 558,
    SBK_QRHI_BEGINFRAMEFLAG_IDX                              = 554,
    SBK_QFLAGS_QRHI_BEGINFRAMEFLAG_IDX                       = 186,
    SBK_QRHI_ENDFRAMEFLAG_IDX                                = 556,
    SBK_QFLAGS_QRHI_ENDFRAMEFLAG_IDX                         = 188,
    SBK_QRHI_RESOURCELIMIT_IDX                               = 566,
    SBK_QRHI_IDX                                             = 552,
    SBK_QRHIBUFFER_TYPE_IDX                                  = 570,
    SBK_QRHIBUFFER_USAGEFLAG_IDX                             = 572,
    SBK_QFLAGS_QRHIBUFFER_USAGEFLAG_IDX                      = 192,
    SBK_QRHIBUFFER_IDX                                       = 568,
    SBK_QRHICOLORATTACHMENT_IDX                              = 574,
    SBK_QRHICOMMANDBUFFER_INDEXFORMAT_IDX                    = 580,
    SBK_QRHICOMMANDBUFFER_BEGINPASSFLAG_IDX                  = 578,
    SBK_QFLAGS_QRHICOMMANDBUFFER_BEGINPASSFLAG_IDX           = 194,
    SBK_QRHICOMMANDBUFFER_IDX                                = 576,
    SBK_QRHICOMPUTEPIPELINE_FLAG_IDX                         = 584,
    SBK_QFLAGS_QRHICOMPUTEPIPELINE_FLAG_IDX                  = 196,
    SBK_QRHICOMPUTEPIPELINE_IDX                              = 582,
    SBK_QRHIDEPTHSTENCILCLEARVALUE_IDX                       = 586,
    SBK_QRHIDRIVERINFO_DEVICETYPE_IDX                        = 590,
    SBK_QRHIDRIVERINFO_IDX                                   = 588,
    SBK_QRHIGLES2INITPARAMS_IDX                              = 592,
    SBK_QRHIGLES2NATIVEHANDLES_IDX                           = 594,
    SBK_QRHIGRAPHICSPIPELINE_FLAG_IDX                        = 608,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_FLAG_IDX                 = 200,
    SBK_QRHIGRAPHICSPIPELINE_TOPOLOGY_IDX                    = 620,
    SBK_QRHIGRAPHICSPIPELINE_CULLMODE_IDX                    = 606,
    SBK_QRHIGRAPHICSPIPELINE_FRONTFACE_IDX                   = 610,
    SBK_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX          = 602,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX   = 198,
    SBK_QRHIGRAPHICSPIPELINE_BLENDFACTOR_IDX                 = 598,
    SBK_QRHIGRAPHICSPIPELINE_BLENDOP_IDX                     = 600,
    SBK_QRHIGRAPHICSPIPELINE_COMPAREOP_IDX                   = 604,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOP_IDX                   = 614,
    SBK_QRHIGRAPHICSPIPELINE_POLYGONMODE_IDX                 = 612,
    SBK_QRHIGRAPHICSPIPELINE_IDX                             = 596,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOPSTATE_IDX              = 616,
    SBK_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX                 = 618,
    SBK_QRHIINITPARAMS_IDX                                   = 622,
    SBK_QRHIMETALINITPARAMS_IDX                              = 624,
    SBK_QRHINATIVEHANDLES_IDX                                = 626,
    SBK_QRHINULLINITPARAMS_IDX                               = 628,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 630,
    SBK_QRHIREADBACKRESULT_IDX                               = 632,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 638,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 636,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 202,
    SBK_QRHIRENDERBUFFER_IDX                                 = 634,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 640,
    SBK_QRHIRENDERTARGET_IDX                                 = 642,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 646,
    SBK_QRHIRESOURCE_IDX                                     = 644,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 648,
    SBK_QRHISAMPLER_FILTER_IDX                               = 656,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 652,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 654,
    SBK_QRHISAMPLER_IDX                                      = 650,
    SBK_QRHISCISSOR_IDX                                      = 658,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 672,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 668,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 204,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 660,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 662,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 664,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 666,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 670,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 676,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 206,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 674,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 680,
    SBK_QRHISHADERSTAGE_IDX                                  = 678,
    SBK_QRHISTATS_IDX                                        = 682,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 686,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 208,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 688,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 690,
    SBK_QRHISWAPCHAIN_IDX                                    = 684,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 692,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 696,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 210,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 698,
    SBK_QRHITEXTURE_IDX                                      = 694,
    SBK_QRHITEXTURE_VIEWFORMAT_IDX                           = 700,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 702,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 706,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 212,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 704,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 708,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 710,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 712,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 714,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 718,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 716,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 722,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 720,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 724,
    SBK_QRHIVIEWPORT_IDX                                     = 726,
    SBK_QSCREEN_IDX                                          = 728,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 732,
    SBK_QSCROLLEVENT_IDX                                     = 730,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 734,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 738,
    SBK_QSESSIONMANAGER_IDX                                  = 736,
    SBK_QSHADER_STAGE_IDX                                    = 746,
    SBK_QSHADER_SOURCE_IDX                                   = 744,
    SBK_QSHADER_VARIANT_IDX                                  = 748,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 742,
    SBK_QSHADER_IDX                                          = 740,
    SBK_QSHADERCODE_IDX                                      = 750,
    SBK_QSHADERKEY_IDX                                       = 752,
    SBK_QSHADERVERSION_FLAG_IDX                              = 756,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 214,
    SBK_QSHADERVERSION_IDX                                   = 754,
    SBK_QSHORTCUT_IDX                                        = 758,
    SBK_QSHORTCUTEVENT_IDX                                   = 760,
    SBK_QSHOWEVENT_IDX                                       = 762,
    SBK_QSINGLEPOINTEVENT_IDX                                = 764,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 768,
    SBK_QSTANDARDITEM_IDX                                    = 766,
    SBK_QSTANDARDITEMMODEL_IDX                               = 770,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 774,
    SBK_QSTATICTEXT_IDX                                      = 772,
    SBK_QSTATUSTIPEVENT_IDX                                  = 776,
    SBK_QSTYLEHINTS_IDX                                      = 778,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 782,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 784,
    SBK_QSURFACE_IDX                                         = 780,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 790,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 216,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 796,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 794,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 792,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 788,
    SBK_QSURFACEFORMAT_IDX                                   = 786,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 798,
    SBK_QTABLETEVENT_IDX                                     = 800,
    SBK_QTEXTBLOCK_IDX                                       = 802,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 804,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 966,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 808,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 806,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 810,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 812,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 820,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 818,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 816,
    SBK_QTEXTCHARFORMAT_IDX                                  = 814,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 824,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 826,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 828,
    SBK_QTEXTCURSOR_IDX                                      = 822,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 836,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 834,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 220,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 832,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 218,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 838,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 840,
    SBK_QTEXTDOCUMENT_IDX                                    = 830,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 842,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 844,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 848,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 854,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 850,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 852,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 222,
    SBK_QTEXTFORMAT_IDX                                      = 846,
    SBK_QTEXTFRAGMENT_IDX                                    = 856,
    SBK_QTEXTFRAME_IDX                                       = 858,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 860,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 866,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 864,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 862,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 868,
    SBK_QTEXTINLINEOBJECT_IDX                                = 870,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 874,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 224,
    SBK_QTEXTITEM_IDX                                        = 872,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 882,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 226,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 878,
    SBK_QTEXTLAYOUT_IDX                                      = 876,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 880,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 886,
    SBK_QTEXTLENGTH_IDX                                      = 884,
    SBK_QTEXTLINE_EDGE_IDX                                   = 892,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 890,
    SBK_QTEXTLINE_IDX                                        = 888,
    SBK_QTEXTLIST_IDX                                        = 894,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 898,
    SBK_QTEXTLISTFORMAT_IDX                                  = 896,
    SBK_QTEXTOBJECT_IDX                                      = 900,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 902,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 910,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 912,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 906,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 228,
    SBK_QTEXTOPTION_IDX                                      = 904,
    SBK_QTEXTOPTION_TAB_IDX                                  = 908,
    SBK_QTEXTTABLE_IDX                                       = 914,
    SBK_QTEXTTABLECELL_IDX                                   = 916,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 918,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 920,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 922,
    SBK_QTOUCHEVENT_IDX                                      = 924,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 928,
    SBK_QTRANSFORM_IDX                                       = 926,
    SBK_QUNDOCOMMAND_IDX                                     = 930,
    SBK_QUNDOGROUP_IDX                                       = 932,
    SBK_QUNDOSTACK_IDX                                       = 934,
    SBK_QVALIDATOR_STATE_IDX                                 = 938,
    SBK_QVALIDATOR_IDX                                       = 936,
    SBK_QVECTOR2D_IDX                                        = 940,
    SBK_QVECTOR3D_IDX                                        = 942,
    SBK_QVECTOR4D_IDX                                        = 944,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 946,
    SBK_QWHEELEVENT_IDX                                      = 948,
    SBK_QWINDOW_VISIBILITY_IDX                               = 954,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 952,
    SBK_QWINDOW_IDX                                          = 950,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 956,
    SBK_QTGUIQT_IDX                                          = 958,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 962,
    SBK_QTGUI_IDX_COUNT                                      = 968,
};
...
enum : int {
    ...
    SBK_QFont_HintingPreference_IDX                          = 482,
    ...
    SBK_QPdfOutputIntent_IDX                                 = 239,
    SBK_QPdfWriter_ColorModel_IDX                            = 241,
    SBK_QPdfWriter_IDX                                       = 240,
    SBK_QPen_IDX                                             = 242,
    SBK_QPicture_IDX                                         = 243,
    SBK_QPixelFormat_ColorModel_IDX                          = 249,
    SBK_QPixelFormat_AlphaUsage_IDX                          = 247,
    SBK_QPixelFormat_AlphaPosition_IDX                       = 245,
    SBK_QPixelFormat_AlphaPremultiplied_IDX                  = 246,
    SBK_QPixelFormat_TypeInterpretation_IDX                  = 250,
    SBK_QPixelFormat_YUVLayout_IDX                           = 251,
    SBK_QPixelFormat_ByteOrder_IDX                           = 248,
    SBK_QPixelFormat_IDX                                     = 244,
    SBK_QPixmap_IDX                                          = 252,
    SBK_QPixmapCache_IDX                                     = 253,
    SBK_QPixmapCache_Key_IDX                                 = 254,
    SBK_QPlatformSurfaceEvent_SurfaceEventType_IDX           = 256,
    SBK_QPlatformSurfaceEvent_IDX                            = 255,
    SBK_QPointerEvent_IDX                                    = 257,
    SBK_QPointingDevice_PointerType_IDX                      = 260,
    SBK_QFlags_QPointingDevice_PointerType_IDX               = 91,
    SBK_QPointingDevice_GrabTransition_IDX                   = 259,
    SBK_QPointingDevice_IDX                                  = 258,
    SBK_QPointingDeviceUniqueId_IDX                          = 261,
    SBK_QPolygon_IDX                                         = 262,
    SBK_QPolygonF_IDX                                        = 263,
    SBK_QPyTextObject_IDX                                    = 264,
    SBK_QQuaternion_IDX                                      = 265,
    SBK_QRadialGradient_IDX                                  = 266,
    SBK_QRasterWindow_IDX                                    = 267,
    SBK_QRawFont_AntialiasingType_IDX                        = 269,
    SBK_QRawFont_LayoutFlag_IDX                              = 270,
    SBK_QFlags_QRawFont_LayoutFlag_IDX                       = 92,
    SBK_QRawFont_IDX                                         = 268,
    SBK_QRegion_RegionType_IDX                               = 272,
    SBK_QRegion_IDX                                          = 271,
    SBK_QRegularExpressionValidator_IDX                      = 273,
    SBK_QResizeEvent_IDX                                     = 274,
    SBK_QRgba64_IDX                                          = 275,
    SBK_QRhi_Implementation_IDX                              = 282,
    SBK_QRhi_Flag_IDX                                        = 280,
    SBK_QFlags_QRhi_Flag_IDX                                 = 95,
    SBK_QRhi_FrameOpResult_IDX                               = 281,
    SBK_QRhi_Feature_IDX                                     = 279,
    SBK_QRhi_BeginFrameFlag_IDX                              = 277,
    SBK_QFlags_QRhi_BeginFrameFlag_IDX                       = 93,
    SBK_QRhi_EndFrameFlag_IDX                                = 278,
    SBK_QFlags_QRhi_EndFrameFlag_IDX                         = 94,
    SBK_QRhi_ResourceLimit_IDX                               = 283,
    SBK_QRhi_IDX                                             = 276,
    SBK_QRhiBuffer_Type_IDX                                  = 285,
    SBK_QRhiBuffer_UsageFlag_IDX                             = 286,
    SBK_QFlags_QRhiBuffer_UsageFlag_IDX                      = 96,
    SBK_QRhiBuffer_IDX                                       = 284,
    SBK_QRhiColorAttachment_IDX                              = 287,
    SBK_QRhiCommandBuffer_IndexFormat_IDX                    = 290,
    SBK_QRhiCommandBuffer_BeginPassFlag_IDX                  = 289,
    SBK_QFlags_QRhiCommandBuffer_BeginPassFlag_IDX           = 97,
    SBK_QRhiCommandBuffer_IDX                                = 288,
    SBK_QRhiComputePipeline_Flag_IDX                         = 292,
    SBK_QFlags_QRhiComputePipeline_Flag_IDX                  = 98,
    SBK_QRhiComputePipeline_IDX                              = 291,
    SBK_QRhiDepthStencilClearValue_IDX                       = 293,
    SBK_QRhiDriverInfo_DeviceType_IDX                        = 295,
    SBK_QRhiDriverInfo_IDX                                   = 294,
    SBK_QRhiGles2InitParams_IDX                              = 296,
    SBK_QRhiGles2NativeHandles_IDX                           = 297,
    SBK_QRhiGraphicsPipeline_Flag_IDX                        = 304,
    SBK_QFlags_QRhiGraphicsPipeline_Flag_IDX                 = 100,
    SBK_QRhiGraphicsPipeline_Topology_IDX                    = 310,
    SBK_QRhiGraphicsPipeline_CullMode_IDX                    = 303,
    SBK_QRhiGraphicsPipeline_FrontFace_IDX                   = 305,
    SBK_QRhiGraphicsPipeline_ColorMaskComponent_IDX          = 301,
    SBK_QFlags_QRhiGraphicsPipeline_ColorMaskComponent_IDX   = 99,
    SBK_QRhiGraphicsPipeline_BlendFactor_IDX                 = 299,
    SBK_QRhiGraphicsPipeline_BlendOp_IDX                     = 300,
    SBK_QRhiGraphicsPipeline_CompareOp_IDX                   = 302,
    SBK_QRhiGraphicsPipeline_StencilOp_IDX                   = 307,
    SBK_QRhiGraphicsPipeline_PolygonMode_IDX                 = 306,
    SBK_QRhiGraphicsPipeline_IDX                             = 298,
    SBK_QRhiGraphicsPipeline_StencilOpState_IDX              = 308,
    SBK_QRhiGraphicsPipeline_TargetBlend_IDX                 = 309,
    SBK_QRhiInitParams_IDX                                   = 311,
    SBK_QRhiMetalInitParams_IDX                              = 312,
    SBK_QRhiNativeHandles_IDX                                = 313,
    SBK_QRhiNullInitParams_IDX                               = 314,
    SBK_QRhiReadbackDescription_IDX                          = 315,
    SBK_QRhiReadbackResult_IDX                               = 316,
    SBK_QRhiRenderBuffer_Type_IDX                            = 319,
    SBK_QRhiRenderBuffer_Flag_IDX                            = 318,
    SBK_QFlags_QRhiRenderBuffer_Flag_IDX                     = 101,
    SBK_QRhiRenderBuffer_IDX                                 = 317,
    SBK_QRhiRenderPassDescriptor_IDX                         = 320,
    SBK_QRhiRenderTarget_IDX                                 = 321,
    SBK_QRhiResource_Type_IDX                                = 323,
    SBK_QRhiResource_IDX                                     = 322,
    SBK_QRhiResourceUpdateBatch_IDX                          = 324,
    SBK_QRhiSampler_Filter_IDX                               = 328,
    SBK_QRhiSampler_AddressMode_IDX                          = 326,
    SBK_QRhiSampler_CompareOp_IDX                            = 327,
    SBK_QRhiSampler_IDX                                      = 325,
    SBK_QRhiScissor_IDX                                      = 329,
    SBK_QRhiShaderResourceBinding_Type_IDX                   = 336,
    SBK_QRhiShaderResourceBinding_StageFlag_IDX              = 334,
    SBK_QFlags_QRhiShaderResourceBinding_StageFlag_IDX       = 102,
    SBK_QRhiShaderResourceBinding_IDX                        = 330,
    SBK_QRhiShaderResourceBinding_Data_IDX                   = 331,
    SBK_QRhiShaderResourceBinding_Data_StorageBufferData_IDX = 332,
    SBK_QRhiShaderResourceBinding_Data_StorageImageData_IDX  = 333,
    SBK_QRhiShaderResourceBinding_TextureAndSampler_IDX      = 335,
    SBK_QRhiShaderResourceBindings_UpdateFlag_IDX            = 338,
    SBK_QFlags_QRhiShaderResourceBindings_UpdateFlag_IDX     = 103,
    SBK_QRhiShaderResourceBindings_IDX                       = 337,
    SBK_QRhiShaderStage_Type_IDX                             = 340,
    SBK_QRhiShaderStage_IDX                                  = 339,
    SBK_QRhiStats_IDX                                        = 341,
    SBK_QRhiSwapChain_Flag_IDX                               = 343,
    SBK_QFlags_QRhiSwapChain_Flag_IDX                        = 104,
    SBK_QRhiSwapChain_Format_IDX                             = 344,
    SBK_QRhiSwapChain_StereoTargetBuffer_IDX                 = 345,
    SBK_QRhiSwapChain_IDX                                    = 342,
    SBK_QRhiSwapChainRenderTarget_IDX                        = 346,
    SBK_QRhiTexture_Flag_IDX                                 = 348,
    SBK_QFlags_QRhiTexture_Flag_IDX                          = 105,
    SBK_QRhiTexture_Format_IDX                               = 349,
    SBK_QRhiTexture_IDX                                      = 347,
    SBK_QRhiTexture_ViewFormat_IDX                           = 350,
    SBK_QRhiTextureCopyDescription_IDX                       = 351,
    SBK_QRhiTextureRenderTarget_Flag_IDX                     = 353,
    SBK_QFlags_QRhiTextureRenderTarget_Flag_IDX              = 106,
    SBK_QRhiTextureRenderTarget_IDX                          = 352,
    SBK_QRhiTextureRenderTargetDescription_IDX               = 354,
    SBK_QRhiTextureSubresourceUploadDescription_IDX          = 355,
    SBK_QRhiTextureUploadDescription_IDX                     = 356,
    SBK_QRhiTextureUploadEntry_IDX                           = 357,
    SBK_QRhiVertexInputAttribute_Format_IDX                  = 359,
    SBK_QRhiVertexInputAttribute_IDX                         = 358,
    SBK_QRhiVertexInputBinding_Classification_IDX            = 361,
    SBK_QRhiVertexInputBinding_IDX                           = 360,
    SBK_QRhiVertexInputLayout_IDX                            = 362,
    SBK_QRhiViewport_IDX                                     = 363,
    SBK_QScreen_IDX                                          = 364,
    SBK_QScrollEvent_ScrollState_IDX                         = 366,
    SBK_QScrollEvent_IDX                                     = 365,
    SBK_QScrollPrepareEvent_IDX                              = 367,
    SBK_QSessionManager_RestartHint_IDX                      = 369,
    SBK_QSessionManager_IDX                                  = 368,
    SBK_QShader_Stage_IDX                                    = 373,
    SBK_QShader_Source_IDX                                   = 372,
    SBK_QShader_Variant_IDX                                  = 374,
    SBK_QShader_SerializedFormatVersion_IDX                  = 371,
    SBK_QShader_IDX                                          = 370,
    SBK_QShaderCode_IDX                                      = 375,
    SBK_QShaderKey_IDX                                       = 376,
    SBK_QShaderVersion_Flag_IDX                              = 378,
    SBK_QFlags_QShaderVersion_Flag_IDX                       = 107,
    SBK_QShaderVersion_IDX                                   = 377,
    SBK_QShortcut_IDX                                        = 379,
    SBK_QShortcutEvent_IDX                                   = 380,
    SBK_QShowEvent_IDX                                       = 381,
    SBK_QSinglePointEvent_IDX                                = 382,
    SBK_QStandardItem_ItemType_IDX                           = 384,
    SBK_QStandardItem_IDX                                    = 383,
    SBK_QStandardItemModel_IDX                               = 385,
    SBK_QStaticText_PerformanceHint_IDX                      = 387,
    SBK_QStaticText_IDX                                      = 386,
    SBK_QStatusTipEvent_IDX                                  = 388,
    SBK_QStyleHints_IDX                                      = 389,
    SBK_QSurface_SurfaceClass_IDX                            = 391,
    SBK_QSurface_SurfaceType_IDX                             = 392,
    SBK_QSurface_IDX                                         = 390,
    SBK_QSurfaceFormat_FormatOption_IDX                      = 395,
    SBK_QFlags_QSurfaceFormat_FormatOption_IDX               = 108,
    SBK_QSurfaceFormat_SwapBehavior_IDX                      = 398,
    SBK_QSurfaceFormat_RenderableType_IDX                    = 397,
    SBK_QSurfaceFormat_OpenGLContextProfile_IDX              = 396,
    SBK_QSurfaceFormat_ColorSpace_IDX                        = 394,
    SBK_QSurfaceFormat_IDX                                   = 393,
    SBK_QSyntaxHighlighter_IDX                               = 399,
    SBK_QTabletEvent_IDX                                     = 400,
    SBK_QTextBlock_IDX                                       = 401,
    SBK_QTextBlock_iterator_IDX                              = 402,
    SBK_QTextBlockFormat_LineHeightTypes_IDX                 = 483,
    SBK_QTextBlockFormat_MarkerType_IDX                      = 404,
    SBK_QTextBlockFormat_IDX                                 = 403,
    SBK_QTextBlockGroup_IDX                                  = 405,
    SBK_QTextBlockUserData_IDX                               = 406,
    SBK_QTextCharFormat_VerticalAlignment_IDX                = 410,
    SBK_QTextCharFormat_UnderlineStyle_IDX                   = 409,
    SBK_QTextCharFormat_FontPropertiesInheritanceBehavior_IDX = 408,
    SBK_QTextCharFormat_IDX                                  = 407,
    SBK_QTextCursor_MoveMode_IDX                             = 412,
    SBK_QTextCursor_MoveOperation_IDX                        = 413,
    SBK_QTextCursor_SelectionType_IDX                        = 414,
    SBK_QTextCursor_IDX                                      = 411,
    SBK_QTextDocument_MetaInformation_IDX                    = 418,
    SBK_QTextDocument_MarkdownFeature_IDX                    = 417,
    SBK_QFlags_QTextDocument_MarkdownFeature_IDX             = 110,
    SBK_QTextDocument_FindFlag_IDX                           = 416,
    SBK_QFlags_QTextDocument_FindFlag_IDX                    = 109,
    SBK_QTextDocument_ResourceType_IDX                       = 419,
    SBK_QTextDocument_Stacks_IDX                             = 420,
    SBK_QTextDocument_IDX                                    = 415,
    SBK_QTextDocumentFragment_IDX                            = 421,
    SBK_QTextDocumentWriter_IDX                              = 422,
    SBK_QTextFormat_FormatType_IDX                           = 424,
    SBK_QTextFormat_Property_IDX                             = 427,
    SBK_QTextFormat_ObjectTypes_IDX                          = 425,
    SBK_QTextFormat_PageBreakFlag_IDX                        = 426,
    SBK_QFlags_QTextFormat_PageBreakFlag_IDX                 = 111,
    SBK_QTextFormat_IDX                                      = 423,
    SBK_QTextFragment_IDX                                    = 428,
    SBK_QTextFrame_IDX                                       = 429,
    SBK_QTextFrame_iterator_IDX                              = 430,
    SBK_QTextFrameFormat_Position_IDX                        = 433,
    SBK_QTextFrameFormat_BorderStyle_IDX                     = 432,
    SBK_QTextFrameFormat_IDX                                 = 431,
    SBK_QTextImageFormat_IDX                                 = 434,
    SBK_QTextInlineObject_IDX                                = 435,
    SBK_QTextItem_RenderFlag_IDX                             = 437,
    SBK_QFlags_QTextItem_RenderFlag_IDX                      = 112,
    SBK_QTextItem_IDX                                        = 436,
    SBK_QTextLayout_GlyphRunRetrievalFlag_IDX                = 441,
    SBK_QFlags_QTextLayout_GlyphRunRetrievalFlag_IDX         = 113,
    SBK_QTextLayout_CursorMode_IDX                           = 439,
    SBK_QTextLayout_IDX                                      = 438,
    SBK_QTextLayout_FormatRange_IDX                          = 440,
    SBK_QTextLength_Type_IDX                                 = 443,
    SBK_QTextLength_IDX                                      = 442,
    SBK_QTextLine_Edge_IDX                                   = 446,
    SBK_QTextLine_CursorPosition_IDX                         = 445,
    SBK_QTextLine_IDX                                        = 444,
    SBK_QTextList_IDX                                        = 447,
    SBK_QTextListFormat_Style_IDX                            = 449,
    SBK_QTextListFormat_IDX                                  = 448,
    SBK_QTextObject_IDX                                      = 450,
    SBK_QTextObjectInterface_IDX                             = 451,
    SBK_QTextOption_TabType_IDX                              = 455,
    SBK_QTextOption_WrapMode_IDX                             = 456,
    SBK_QTextOption_Flag_IDX                                 = 453,
    SBK_QFlags_QTextOption_Flag_IDX                          = 114,
    SBK_QTextOption_IDX                                      = 452,
    SBK_QTextOption_Tab_IDX                                  = 454,
    SBK_QTextTable_IDX                                       = 457,
    SBK_QTextTableCell_IDX                                   = 458,
    SBK_QTextTableCellFormat_IDX                             = 459,
    SBK_QTextTableFormat_IDX                                 = 460,
    SBK_QToolBarChangeEvent_IDX                              = 461,
    SBK_QTouchEvent_IDX                                      = 462,
    SBK_QTransform_TransformationType_IDX                    = 464,
    SBK_QTransform_IDX                                       = 463,
    SBK_QUndoCommand_IDX                                     = 465,
    SBK_QUndoGroup_IDX                                       = 466,
    SBK_QUndoStack_IDX                                       = 467,
    SBK_QValidator_State_IDX                                 = 469,
    SBK_QValidator_IDX                                       = 468,
    SBK_QVector2D_IDX                                        = 470,
    SBK_QVector3D_IDX                                        = 471,
    SBK_QVector4D_IDX                                        = 472,
    SBK_QWhatsThisClickedEvent_IDX                           = 473,
    SBK_QWheelEvent_IDX                                      = 474,
    SBK_QWindow_Visibility_IDX                               = 477,
    SBK_QWindow_AncestorMode_IDX                             = 476,
    SBK_QWindow_IDX                                          = 475,
    SBK_QWindowStateChangeEvent_IDX                          = 478,
    SBK_QtGuiQt_IDX                                          = 479,
    SBK_QtGuiHelper_QOverrideCursorGuard_IDX                 = 481,
    SBK_QtGui_IDX_COUNT                                      = 484,
};
