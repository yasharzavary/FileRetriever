...
enum [[deprecated]] : int {
    ...
    SBK_QTSPATIALAUDIO_QLIST_QOBJECTPTR_IDX                  = 2, // QList<QObject*>
    SBK_QTSPATIALAUDIO_QLIST_QBYTEARRAY_IDX                  = 4, // QList<QByteArray>
    SBK_QTSPATIALAUDIO_QLIST_QVARIANT_IDX                    = 6, // QList<QVariant>
    SBK_QTSPATIALAUDIO_QLIST_QSTRING_IDX                     = 8, // QList<QString>
    SBK_QTSPATIALAUDIO_QMAP_QSTRING_QVARIANT_IDX             = 10, // QMap<QString,QVariant>
    SBK_QTSPATIALAUDIO_CONVERTERS_IDX_COUNT                  = 12,
};
