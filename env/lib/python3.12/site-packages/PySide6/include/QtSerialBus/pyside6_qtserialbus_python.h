...
enum [[deprecated]] : int {
    ...
    SBK_QTSERIALBUS_QLIST_QOBJECTPTR_IDX                     = 22, // QList<QObject*>
    SBK_QTSERIALBUS_QLIST_QBYTEARRAY_IDX                     = 24, // QList<QByteArray>
    SBK_QTSERIALBUS_QLIST_QMODBUSDEVICE_INTERMEDIATEERROR_IDX = 26, // QList<QModbusDevice::IntermediateError>
    SBK_QTSERIALBUS_QMAP_QMODBUSDATAUNIT_REGISTERTYPE_QMODBUSDATAUNIT_IDX = 28, // QMap<QModbusDataUnit::RegisterType,QModbusDataUnit>
    SBK_QTSERIALBUS_QLIST_QCANBUSDEVICE_CONFIGURATIONKEY_IDX = 30, // QList<QCanBusDevice::ConfigurationKey>
    SBK_QTSERIALBUS_QLIST_QCANBUSFRAME_IDX                   = 32, // QList<QCanBusFrame>
    SBK_QTSERIALBUS_QLIST_QVARIANT_IDX                       = 34, // QList<QVariant>
    SBK_QTSERIALBUS_QLIST_QSTRING_IDX                        = 36, // QList<QString>
    SBK_QTSERIALBUS_CONVERTERS_IDX_COUNT                     = 38,
};
...
enum : int {
    ...
    SBK_QtSerialBus_QList_QObjectPTR_IDX                     = 11, // QList<QObject*>
    SBK_QtSerialBus_QList_QByteArray_IDX                     = 12, // QList<QByteArray>
    SBK_QtSerialBus_QList_QModbusDevice_IntermediateError_IDX = 13, // QList<QModbusDevice::IntermediateError>
    SBK_QtSerialBus_QMap_QModbusDataUnit_RegisterType_QModbusDataUnit_IDX = 14, // QMap<QModbusDataUnit::RegisterType,QModbusDataUnit>
    SBK_QtSerialBus_QList_QCanBusDevice_ConfigurationKey_IDX = 15, // QList<QCanBusDevice::ConfigurationKey>
    SBK_QtSerialBus_QList_QCanBusFrame_IDX                   = 16, // QList<QCanBusFrame>
    SBK_QtSerialBus_QList_QVariant_IDX                       = 17, // QList<QVariant>
    SBK_QtSerialBus_QList_QString_IDX                        = 18, // QList<QString>
    SBK_QtSerialBus_CONVERTERS_IDX_COUNT                     = 19,
};
