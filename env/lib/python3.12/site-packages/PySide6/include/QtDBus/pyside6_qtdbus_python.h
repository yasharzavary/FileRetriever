...
enum [[deprecated]] : int {
    ...
    SBK_QTDBUS_QLIST_QOBJECTPTR_IDX                          = 8, // QList<QObject*>
    SBK_QTDBUS_QLIST_QBYTEARRAY_IDX                          = 10, // QList<QByteArray>
    SBK_QTDBUS_QLIST_QSTRING_IDX                             = 12, // QList<QString>
    SBK_QTDBUS_CONVERTERS_IDX_COUNT                          = 14,
};
