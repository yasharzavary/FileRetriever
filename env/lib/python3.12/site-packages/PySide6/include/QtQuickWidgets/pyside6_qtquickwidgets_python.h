...
enum [[deprecated]] : int {
    ...
    SBK_QTQUICKWIDGETS_QLIST_QACTIONPTR_IDX                  = 2, // QList<QAction*>
    SBK_QTQUICKWIDGETS_QLIST_QQMLERROR_IDX                   = 4, // QList<QQmlError>
    SBK_QTQUICKWIDGETS_QLIST_QVARIANT_IDX                    = 6, // QList<QVariant>
    SBK_QTQUICKWIDGETS_QLIST_QSTRING_IDX                     = 8, // QList<QString>
    SBK_QTQUICKWIDGETS_QMAP_QSTRING_QVARIANT_IDX             = 10, // QMap<QString,QVariant>
    SBK_QTQUICKWIDGETS_CONVERTERS_IDX_COUNT                  = 12,
};
