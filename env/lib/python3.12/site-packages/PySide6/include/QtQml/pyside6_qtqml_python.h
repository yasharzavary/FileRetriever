...
enum [[deprecated]] : int {
    ...
    SBK_QTQML_QLIST_QOBJECTPTR_IDX                           = 10, // QList<QObject*>
    SBK_QTQML_QLIST_QBYTEARRAY_IDX                           = 12, // QList<QByteArray>
    SBK_QTQML_QLIST_QQMLCONTEXT_PROPERTYPAIR_IDX             = 14, // QList<QQmlContext::PropertyPair>
    SBK_QTQML_QLIST_QQMLABSTRACTURLINTERCEPTORPTR_IDX        = 16, // QList<QQmlAbstractUrlInterceptor*>
    SBK_QTQML_QLIST_QVARIANT_IDX                             = 18, // QList<QVariant>
    SBK_QTQML_QLIST_QSTRING_IDX                              = 20, // QList<QString>
    SBK_QTQML_CONVERTERS_IDX_COUNT                           = 22,
};
