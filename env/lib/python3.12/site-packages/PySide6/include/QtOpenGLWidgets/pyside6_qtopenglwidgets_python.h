...
enum [[deprecated]] : int {
    ...
    SBK_QTOPENGLWIDGETS_QLIST_QACTIONPTR_IDX                 = 2, // QList<QAction*>
    SBK_QTOPENGLWIDGETS_QLIST_QVARIANT_IDX                   = 4, // QList<QVariant>
    SBK_QTOPENGLWIDGETS_QLIST_QSTRING_IDX                    = 6, // QList<QString>
    SBK_QTOPENGLWIDGETS_QMAP_QSTRING_QVARIANT_IDX            = 8, // QMap<QString,QVariant>
    SBK_QTOPENGLWIDGETS_CONVERTERS_IDX_COUNT                 = 10,
};
